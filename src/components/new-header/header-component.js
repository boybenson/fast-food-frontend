        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-2 md:justify-start md:space-x-10">
          ...
          {!userInfo && (
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              ...
              <NavLink
                to="/auth/signup"
                className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2  border border-transparent rounded-lg shadow-sm text-base font-medium text-white bg-primary hover:bg-red-700"
              >
                Get Started
              </NavLink>
            </div>
          ...
          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
            <div className="pt-5 pb-6 px-5">
              ...
              <div className="mt-6">
                <NavLink
                  to="/"
                  className="-m-3 p-3 gap-x-2 flex items-center rounded-md hover:bg-gray-50"
                >
                  <HomeIcon className="flex-shrink-0 h-6 w-6" />
                  <p>Home</p>
                </NavLink>
                <NavLink
                  to="/en/account/personal-info"
            ...
            <div className="py-6 px-5 space-y-6">
              <div>
                ...
                {userInfo && (
                  <button
                    className="w-full flex gap-x-2  items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-primary"
                    onClick={() => handleLogout()}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
